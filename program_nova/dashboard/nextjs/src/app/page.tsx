...
export default function Home() {
  ...
  return (
    <div className="flex h-screen overflow-hidden flex-col">
      ...
      {/* Main layout - changes based on plan mode */}
      <div className="flex flex-1 overflow-hidden">
        {/* Main content area - hidden in plan mode */}
        {!isPlanMode && (
        ...
        {/* Chat panel - resizable sidebar on the right, full screen in plan mode */}
        <ChatPanel isFullScreen={isPlanMode}>
