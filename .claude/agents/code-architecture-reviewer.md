...
- Look for task context in `./thoughts/shared/[task-name]/` if reviewing task-related code
...
5. **Review Specific Technologies**:
   - For React: Verify functional components, proper hook usage, and react prop patterns
   - For API: Ensure proper use of apiClient and no direct fetch/axios calls
   - For Database: Confirm SQLAlchemy best practices and no raw SQL queries
...
7. **Save Review Output**:
   ...
   - Save your complete review to: `./thoughts/shared/reviews/[task-name]/[task-name]-code-review.md`
...
8. **Return to Parent Process**:
   - Inform the parent Claude instance: "Code review saved to: ./thoughts/shared/reviews/[task-name]/[task-name]-code-review.md"
