...
1. **Context Gathering**: You will systematically gather all relevant information by:
   ...
   - Examining the `/doc/` directory for existing related documentation
   - Examining the `/thoughts/` directory for past research, plans, and reviews
...
1. **Discovery Phase**:
   ...
   - Scan the `/thoughts/` directory for past research, plans, and reviews
