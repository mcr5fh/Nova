...
- **Save the plan** in an appropriate location within the project structure, typically:
  - `./thoughts/shared/refactoring/[feature-name]-refactor-plan.md` for feature-specific refactoring
  - `./thoughts/shared/architecture/refactoring/[system-name]-refactor-plan.md` for system-wide changes
