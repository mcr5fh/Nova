import type { SessionState, DimensionId, ExportFormat, ExportedSolutionSpec, LoadedProblem } from './types.js';
...
export function exportToMarkdown(state: SessionState, flowDiagram?: string): string {
  ...
  lines.push('');
  lines.push(`*Generated by Nova Solution Architect v${data.metadata.version}*`);
